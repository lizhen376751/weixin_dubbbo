...
public final class MapUtils {
    ...
    public static void main(String[] args) {
        ...
        accessToken.setCreateTime(545787587);
        accessToken.setToken("sdsdsdsds");
        accessToken.setTicket("dssdsdsdsdsd");
        Map map = toMap(accessToken);
        log.info("转换成map后" + map.toString());
