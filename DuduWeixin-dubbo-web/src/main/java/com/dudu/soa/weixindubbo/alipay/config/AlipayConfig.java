package com.dudu.soa.weixindubbo.alipay.config;
...
// 璋冭瘯鐢紝鍒涘缓TXT鏃ュ織鏂囦欢澶硅矾寰�
    public static final String LOG_PATH = "i:\\";

    /**
     * The constant input_charset.
     */
...
// 绛惧悕鏂瑰紡 涓嶉渶淇敼
     ...
     */
    public static void getalipay(String shopcode) {
