...
public class ElectronicCoupon implements Serializable {
     ...
     */
    public ElectronicCoupon setCouponId(int couponId) {
     ...
     * @return 返回 ElectronicCoupon(电子优惠券实体类)
     */
    public ElectronicCoupon setCouponName(String couponName) {
     ...
     * @return 返回 ElectronicCoupon(电子优惠券实体类)
     */
    public ElectronicCoupon setDetails(String details) {
     ...
     * @return 返回 ElectronicCoupon(电子优惠券实体类)
     */
    public ElectronicCoupon setCreateUser(String createUser) {
     ...
     * @return 返回 ElectronicCoupon(电子优惠券实体类)
     */
    public ElectronicCoupon setValidStartTime(Date validStartTime) {
     ...
     * @return 返回 ElectronicCoupon(电子优惠券实体类)
     */
    public ElectronicCoupon setValidEndTime(Date validEndTime) {
     ...
     * @return 返回 ElectronicCoupon(电子优惠券实体类)
     */
    public ElectronicCoupon setUsedNum(int usedNum) {
     ...
     * @return 返回 ElectronicCoupon(电子优惠券实体类)
     */
    public ElectronicCoupon setForwardedNum(int forwardedNum) {
     ...
     * @return 返回 ElectronicCoupon(电子优惠券实体类)
     */
    public ElectronicCoupon setCreateTime(Date createTime) {
     ...
     * @return 返回 ElectronicCoupon(电子优惠券实体类)
     */
    public ElectronicCoupon setDiXiaoJinE(BigDecimal diXiaoJinE) {
     ...
     * @return 返回 ElectronicCoupon(电子优惠券实体类)
     */
    public ElectronicCoupon setAnotherJinE(BigDecimal anotherJinE) {
     ...
     * @return 返回 ElectronicCoupon(电子优惠券实体类)
     */
    public ElectronicCoupon setImageCode(String imageCode) {
     ...
     * @return 返回 ElectronicCoupon(电子优惠券实体类)
     */
    public ElectronicCoupon setUpdateTime(Date updateTime) {
     ...
     * @return 返回 ElectronicCoupon(电子优惠券实体类)
     */
    public ElectronicCoupon setUpdateUser(String updateUser) {
     ...
     * @return 返回 ElectronicCoupon(电子优惠券实体类)
     */
    public ElectronicCoupon setState(Integer state) {
        this.state = state;
        return this;
    }
     ...
     * @return 返回 ElectronicCoupon(电子优惠券实体类)
     */
    public ElectronicCoupon setServiceCode(String serviceCode) {
     ...
     * @return 返回 ElectronicCoupon(电子优惠券实体类)
     */
    public ElectronicCoupon setServiceFlag(String serviceFlag) {
