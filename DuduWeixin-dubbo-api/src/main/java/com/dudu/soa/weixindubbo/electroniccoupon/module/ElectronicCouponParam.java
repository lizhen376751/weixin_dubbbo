...
public class ElectronicCouponParam implements Serializable {
    ...
    /**
     * ElectronicCouponParam(电子优惠券参数类) 字符串形式
     *
     * @return ElectronicCouponParam(电子优惠券参数类)字符串
     */
    @Override
     ...
     * @return 返回 ElectronicCouponParam(电子优惠券参数类)
     */
    public ElectronicCouponParam setCouponId(int couponId) {
     ...
     * @return 返回 ElectronicCouponParam(电子优惠券参数类)
     */
    public ElectronicCouponParam setCouponName(String couponName) {
     ...
     * @return 返回 ElectronicCouponParam(电子优惠券参数类)
     */
    public ElectronicCouponParam setDetails(String details) {
     ...
     * @return 返回 ElectronicCouponParam(电子优惠券参数类)
     */
    public ElectronicCouponParam setCreateUser(String createUser) {
     ...
     * @return 返回 ElectronicCouponParam(电子优惠券参数类)
     */
    public ElectronicCouponParam setValidStartTime(Date validStartTime) {
     ...
     * @return 返回 ElectronicCouponParam(电子优惠券参数类)
     */
    public ElectronicCouponParam setValidEndTime(Date validEndTime) {
     ...
     * @return 返回 ElectronicCouponParam(电子优惠券参数类)
     */
    public ElectronicCouponParam setUsedNum(int usedNum) {
     ...
     * @return 返回 ElectronicCouponParam(电子优惠券参数类)
     */
    public ElectronicCouponParam setForwardedNum(int forwardedNum) {
     ...
     * @return 返回 ElectronicCouponParam(电子优惠券参数类)
     */
    public ElectronicCouponParam setCreateTime(Date createTime) {
     ...
     * @return 返回 ElectronicCouponParam(电子优惠券参数类)
     */
    public ElectronicCouponParam setDiXiaoJinE(BigDecimal diXiaoJinE) {
     ...
     * @return 返回 ElectronicCouponParam(电子优惠券参数类)
     */
    public ElectronicCouponParam setAnotherJinE(BigDecimal anotherJinE) {
     ...
     * @return 返回 ElectronicCouponParam(电子优惠券参数类)
     */
    public ElectronicCouponParam setImageCode(String imageCode) {
     ...
     * @return 返回 ElectronicCouponParam(电子优惠券参数类)
     */
    public ElectronicCouponParam setUpdateTime(Date updateTime) {
     ...
     * @return 返回 ElectronicCouponParam(电子优惠券参数类)
     */
    public ElectronicCouponParam setUpdateUser(String updateUser) {
     ...
     * @return 返回 ElectronicCouponParam(电子优惠券参数类)
     */
    public ElectronicCouponParam setState(Integer state) {
        this.state = state;
        return this;
    }
     ...
     * @return 返回 ElectronicCouponParam(电子优惠券参数类)
     */
    public ElectronicCouponParam setServiceCode(String serviceCode) {
     ...
     * @return 返回 ElectronicCouponParam(电子优惠券参数类)
     */
    public ElectronicCouponParam setServiceFlag(String serviceFlag) {
