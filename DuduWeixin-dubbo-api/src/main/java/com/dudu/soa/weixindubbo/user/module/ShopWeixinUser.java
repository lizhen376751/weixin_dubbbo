...
public class ShopWeixinUser implements Serializable {
    ...
    public String toString() {
        return "id:" + id + ",userName:" + userName + ",userPass:" + userPass + ",mobile:" + mobile + ",address:" + address + ",engine:" + engine
                ...
                + ",xingMing:" + xingMing + ",xingBie:" + xingBie + ",carPaiLiang:" + carPaiLiang + ",nickname:" + nickname + ",subscribetime:" + subscribetime;
    }
     ...
     * 设置 用户的关注时间
     *
     * @param subscribetime 用户的关注时间
     * @return 返回 ShopWeixinUser(店管家微信的用户列表)
     */
    public ShopWeixinUser setSubscribetime(String subscribetime) {
